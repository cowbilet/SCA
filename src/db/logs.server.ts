...
export async function dbGetStudentAwardLogs(
    studentId: string,
    award: Award,
    challenge: Challenge,
) {
    return await db
        ...
        .where((log) =>
            and(
                eq(log.studentId, studentId),
                eq(log.award, award),
                eq(log.challenge, challenge),
            ),
        )
}
export async function dbCreateLogEntry(
    studentId: string,
    award: Award,
    challenge: Challenge,
    date: Date,
...
export async function dbEditLogEntry(
    logId: string,
    date: Date,
    description: string,
